  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Texts.headline3('Categories', themeModel.textColor),
        centerTitle: true,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child:
                    Texts.headline3("Add Category", themeModel.accentColor),
                  )
                ],
              ),
            ),
                  ...
                  return GridView.count(
                    ...
                    children: List.generate(categories.length, (index) {
                      return FadeIn(
                          ...
                          child: Cards.category(context,
                              category: categories[index], function: () async {
                                await widget.bloc.removeCategory(categories[index].title);
                                Navigator.pop(context);
                              }));
                    }),
                  );
