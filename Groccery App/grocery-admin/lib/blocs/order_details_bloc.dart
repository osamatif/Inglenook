...
class OrderDetailsBloc {
  ...
  Future<void> setDeliveryBoy(DeliveryBoy deliveryBoy) async {
    ...
    await _sendNotification('You have a new delivery', deliveryBoy.email,
        delivery: true);
  }
  ...
  Future<void> _sendNotification(String msg, String id,
