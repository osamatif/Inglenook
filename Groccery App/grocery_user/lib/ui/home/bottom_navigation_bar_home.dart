      ...
      items: [
        BottomNavigationBarItem(
          icon: Icon(
            Icons.home,
            color:
                (model.indexPage == 0) ? Color(0xFF7BED8D) : Color(0xFFA6BCD0),
          ),
          label: "Home",
        ),
        BottomNavigationBarItem(
          icon: Icon(
            Icons.search,
            color:
                (model.indexPage == 1) ? Color(0xFF7BED8D) : Color(0xFFA6BCD0),
          ),
          label: "Search",
        ),
        BottomNavigationBarItem(
          icon: Icon(
            Icons.shopping_cart,
            color:
                (model.indexPage == 2) ? Color(0xFF7BED8D) : Color(0xFFA6BCD0),
          ),
          label: "Cart",
        ),
        BottomNavigationBarItem(
