  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Texts.headline3('Coupons', themeModel.textColor),
        centerTitle: true,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child:
                        Texts.headline3("Add Coupon", themeModel.accentColor),
                  )
                ],
              ),
            ),
                  ...
                  return GridView.count(
                    ...
                    children: List.generate(coupons.length, (index) {
                      return FadeIn(
                        ...
                        child: Cards.coupon(context, coupon: coupons[index],
                            function: () async {
                          await widget.bloc.deleteCoupon(coupons[index]);
