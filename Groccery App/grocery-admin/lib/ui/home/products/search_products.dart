...
class _SearchProductsState extends State<SearchProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Texts.headline3('Search', themeModel.textColor),
                      ...
                      if (products.length == 0) {
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Texts.headline3('Nothing found!',
                        ...
                        return GridView.count(
                          ...
                          List.generate(snapshot.data!.length, (index) {
                            return FadeIn(
                              child: Cards.product(context,
                                  product: products[index],
                                  edit: widget.bloc.editProductLocally,
                                  delete: () async {
                                    await widget.bloc
                                        .removeProduct(products[index].reference);
                                    Navigator.pop(context);
                                    widget.bloc.removeProductLocally(products[index]);
