                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              ///Order date
                              Texts.subheads("Date: ", themeModel.textColor),
                              Spacer(),
                              Texts.subheads("${widget.order.date}",
                                  ...
                                  child: Align(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Texts.text(widget.order.adminComment!,
                                            themeModel.secondTextColor),
                                      ],
                                    ),
                                  ),
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Wrap(
                                children: [
                                  Container(
                                    child: Texts.subheads("Payment method: ",
                                        themeModel.secondTextColor),
                                  ),
                                  Texts.text(widget.order.paymentMethod,
                                      themeModel.priceColor),
                                ],
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  child: Texts.subheads(
                                      "Delivery:", themeModel.secondTextColor),
                                ),
                                Container(
                                  alignment: Alignment.centerRight,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  child: Texts.subheads(
                                      "Total:", themeModel.secondTextColor),
                                ),
                                Container(
                                  alignment: Alignment.centerRight,
                                  padding: EdgeInsets.only(left: 10),
