          ...
          Container(
            ...
            child: ListTile(
              title: (widget.date == null)
                  ? Texts.headline3("All days", Colors.white)
                  : Texts.text("All days", themeModel.textColor),
              onTap: () {
              ...
              return Container(
                ...
                child: ListTile(
                  title: (dates[position] == widget.date)
                      ? Texts.headline3(dates[position].title, Colors.white)
                      : Texts.text(dates[position].title, themeModel.textColor),
                  onTap: () {
